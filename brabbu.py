...
def pagination(cat1, cat2):
    ...
    while True:
        try:
            ...
            # # move to the element using the actions chain
            # actions.move_to_element(nextPage_elem).perform()

            # scroll to the element using JavaScript
            # driver.execute_script("arguments[0].scrollIntoView();", nextPage_elem)
